 ...
 *	マルチ連動用状態データテキスト作成
 *----------------------------------------------------------------------
 *$Header: p:/presto2/shlib_v7/rzcmdx/src/RCS/rzi046.c 1.1 1970/01/01 00:00:00 chimura Exp $
 *$Log: rzi046.c $
 * リビジョン 1.1  1970/01/01  00:00:00  chimura
 * 初期リビジョン
 * 
 *----------------------------------------------------------------------
 *Header: p:/lib/rzcmdx/src/RCS/rzi046.c 1.3 1999/03/10 10:57:21 itami
 *Log: rzi046.c
 * リビジョン 1.3  1999/03/10  10:57:21  itami
 * 文字列をバッファにセットする時、'0'埋めする。
 *----------------------------------------------------------------------
	...
	)
{
	...
	buf = (BYTE_PTR)&txt->ex_d.dt.c_data[0];
