 ...
 * Original     :
 *----------------------------------------------------------------------
 *$Header: p:/presto2/shlib_v7/drive/fssvr60/fat/api/rcs/fsmount.c 1.4 1970/01/01 00:00:00 kagatume Exp $
 *$Log: fsmount.c $
...
/* 01.07 異常終了時、戻り値にエラー値設定                05/12/12 Y.Yoshizumi */
/* 01.09 R/Wバッファサイズ計算修正                       06/03/01 Y.Yoshizumi */
/******************************************************************************/
...
)
{
	...
	l_work01 += sizeof( TFMR_RWBUFF ) * DFMR_RWBUFFSIZE;    /* ｢R/Wバッファ｣サイズ*/
