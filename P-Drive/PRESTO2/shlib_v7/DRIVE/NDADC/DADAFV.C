 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/ndadc/RCS/dadafv.c 1.2 1970/01/01 00:00:00 m-yamana Exp $
 *$Log: dadafv.c $
 ...
 * 
 *----------------------------------------------------------------------*
 *Header: p:/lib/drive/ndadc/rcs/dadafv.c 1.1 1996/07/22 13:36:13 chimura
 *----------------------------------------------------------------------*/
...
struct txtr {					/* AFV adj complete	*/
	...
	DAD_ARY_PTN	exe_ptn;		/* 実行ﾍｯﾄﾞbit pattern	*/
