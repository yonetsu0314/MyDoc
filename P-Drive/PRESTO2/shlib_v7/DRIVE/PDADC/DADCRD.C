 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/pdadc/rcs/dadcrd.c 1.3 1970/01/01 00:00:00 chimura Exp $
 *$Log: dadcrd.c $
 ...
 * 
 *----------------------------------------------------------------------*
 *Header: p:/presto/shlib_v7/drive/ndadc/rcs/dadcrd.c 1.3 1970/01/01
 *Log: dadcrd.c
 * リビジョン 1.3  1970/01/01  00:00:00  chimura
 * 2003/08/12 ワーニング削除
 * 
	...
	)
{
	...
	id[DADC3] = DAD3RX_SEM_ID;
	id[DADC4] = DAD4RX_SEM_ID;
