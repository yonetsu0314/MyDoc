 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/pdadc/RCS/dadbot3.c 1.1 1970/01/01 00:00:00 chimura Exp $
 *$Log: dadbot3.c $
 * リビジョン 1.1  1970/01/01  00:00:00  chimura
 * 初期リビジョン
 * 
 *----------------------------------------------------------------------*
 *Header: p:/presto/shlib_v7/drive/ndadc/rcs/dadbot3.c 1.3 1970/01/01
 *Log: dadbot3.c
...
/*		p += i;*/
	...
	*(WORD_PTR)p = (unsigned short)((ttm+ TIME_BASE-1)/TIME_BASE);
	...
	_disable();
	rtp->f5tmc = (unsigned short)((ttm +TIME_BASE-1)/TIME_BASE);
	rtp->f4tmc = (unsigned short)((ttm -tm[DAD_FIL_MAX-2] +TIME_BASE-1)/TIME_BASE);
	rtp->f3tmc = (unsigned short)((ttm -tm[DAD_FIL_MAX-2] -tm[DAD_FIL_MAX-3] +TIME_BASE-1)/TIME_BASE);
	_enable();
	return(0);
}
