/*----------------------------------------------------------------------*
 * File name	: com3int.c	/ com20020 interrupt handler		*
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/arcneta/RCS/com3int.c 1.3 1970/01/01 00:00:00 chimura Exp $
 *$Log: com3int.c $
 ...
 * 
 *----------------------------------------------------------------------*
 *Header: p:/lib/drive/_arcnet/rcs/com3int.c 1.1 1995/11/07 17:13:05 ryoji
 *----------------------------------------------------------------------*/
...
#define	DEVNO	3				/* device number	*/

//#pragma interrupt(arcnet3_int_hdr)

void arcnet3_int_hdr(void)
{
