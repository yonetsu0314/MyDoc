 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/arcneta/RCS/comrx.c 1.7 1970/01/01 00:00:00 sakaguti Exp $
 *$Log: comrx.c $
 * リビジョン 1.7  1970/01/01  00:00:00  sakaguti
 * 2004/07/21 15:30:00
 * read関数arcnet_rxについて、ARCNET IC が無い場合、
 * 受信長さ０の応答をするようにした。
 * 
...
{
	if(arc_exist_flag[devno]==0) return(0);	/* ICが無い場合、length=0を返す */
