/*----------------------------------------------------------------------*
 * File name	: com2int.c	/ com20020 interrupt handler		*
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/arcneta/RCS/com2int.c 1.3 1970/01/01 00:00:00 chimura Exp $
 *$Log: com2int.c $
 ...
 * 
 *----------------------------------------------------------------------*
 *Header: p:/lib/drive/_arcnet/rcs/com2int.c 1.1 1995/11/07 17:13:03 ryoji
 *----------------------------------------------------------------------*/
...
#define	DEVNO	2				/* device number	*/

//#pragma interrupt(arcnet2_int_hdr)

void arcnet2_int_hdr(void)
{
