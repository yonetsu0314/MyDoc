 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/drive/scu/sh7615/scic2/RCS/sciint.c 1.5 1970/01/01 00:00:00 chimura Exp $
 *$Log: sciint.c $
 * リビジョン 1.5  1970/01/01  00:00:00  chimura
 * 2008/02/15
 * 送信割り込み待ち状態でエラー割り込みが発生した場合、それ以降の送信処理が
 * 行われない不具合修正。
 * 
...
/*送信許可後にエラーが発生した場合、送信できない状態になるのを防ぐ*/
	if( sctx[SCIF_CH1].flag & TX_ING) {
