/*---------------------------------------------------------------------
 * $Header: p:/presto/shlib_v7/drive/usnets/usnetsh7/netsrc/RCS/multi.c 1.1 1970/01/01 00:00:00 masahiro Exp $
 * $Log: multi.c $
...
ER RunTask0(FP task, PRI prior)
{
    ...
    tskinf.stksz = 0x3000;
    tskinf.stk = NULL;
    tskid = ETHERNET_TSK0_ID;
    cre_tsk(tskid,&tskinf);
