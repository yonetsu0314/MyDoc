...
#*	SH2 ビッグエンディアン用
#*----------------------------------------------------------------------
#*$Header: P:/PRESTO2/shlib_v7/PRCMDX/src/RCS/presh2b_.mk 1.22 2015-05-28 11:05:38+09 itami Exp $
#*$Log: presh2b_.mk $
#*Revision 1.22  2015-05-28 11:05:38+09  itami
#*PRR3017 PRR3018 追加
#*
#*Revision 1.21  2014-06-26 21:02:47+09  hiroe
#**** empty log message ***
#*
#* リビジョン 1.20  1970/01/01  00:00:00  yonetsu
#* 2012/02/15 14:19
#* PRR1015,PRR1016 追加
#* 
#* リビジョン 1.19  1970/01/01  00:00:00  ohtani
#* 2007/10/12 14:08:20
#* 計算結果拡張パラメータコマンドを追加する。(pri1011,pri1012)
#* 
#* リビジョン 1.18  1970/01/01  00:00:00  chimura
#* 2007/03/20 14:30
...
OFILE112=$(PRR1035).obj $(PRR1036).obj $(PRR3017).obj $(PRR3018).obj
...
$(PRR3017).obj : $(PRR3017).c
	$(CC) $(PRR3017).c			>>  $(ERRFILE)
$(PRR3018).obj : $(PRR3018).c
	$(CC) $(PRR3018).c			>>  $(ERRFILE)
