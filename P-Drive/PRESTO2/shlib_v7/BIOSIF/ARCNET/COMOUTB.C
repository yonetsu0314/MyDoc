/*----------------------------------------------------------------------*
 * File name	: comoutb.c	/ output to com20020			*
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/biosif/arcnet/RCS/comoutb.c 1.3 1970/01/01 00:00:00 chimura Exp $
 *$Log: comoutb.c $
...
//	imask_bak = get_imask();
//	set_imask(15);
	err = (int)trapa_svc(VECTOR_ARCNET, 0x5, contxt, reg, mask, data);
//	set_imask( imask_bak );
	return(err);
}
