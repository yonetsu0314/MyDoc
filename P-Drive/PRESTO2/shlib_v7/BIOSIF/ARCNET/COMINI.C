/*----------------------------------------------------------------------*
 * File name	: comini.c	/ initialize com20020			*
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/biosif/arcnet/RCS/comini.c 1.3 1970/01/01 00:00:00 chimura Exp $
 *$Log: comini.c $
...
//	imask_bak = get_imask();
//	set_imask(15);
	err = (void *)trapa_svc(VECTOR_ARCNET, 0x0, dev_no);
//	set_imask( imask_bak );
	return(err);
}
