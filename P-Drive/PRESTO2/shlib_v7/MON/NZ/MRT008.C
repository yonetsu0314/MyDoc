 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/mon/nz/RCS/mrt008.c 1.1 1970/01/01 00:00:00 chimura Exp $
 *$Log: mrt008.c $
 * リビジョン 1.1  1970/01/01  00:00:00  chimura
 * 初期リビジョン
 * 
 *----------------------------------------------------------------------*
 *Header: p:/wcu/main/nz_wcu/uti/rcs/mrt008.c 1.1 1996/07/22 19:25:06
 *Log: mrt008.c
 *----------------------------------------------------------------------*/
	...
	)
{
	...
	if(stat == 0)						return(0);
	if(stat&(DAD_ORG|DAD_1ST|DAD_2ND|DAD_3RD|DAD_4TH)) {
