 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/mon/nz/RCS/mrt003.c 1.2 1970/01/01 00:00:00 kawamura Exp $
 *$Log: mrt003.c $
 * リビジョン 1.2  1970/01/01  00:00:00  kawamura
 * 2003/12/26  12:07
 * rzr009を使用しない。このため、リブートで安定時間の再セットはされない。
 * 
 * リビジョン 1.1  1970/01/01  00:00:00  chimura
 * 初期リビジョン
 * 
 *----------------------------------------------------------------------*
 *Header: p:/wcu/main/nz_wcu/uti/rcs/mrt003.c 1.2 1997/06/19 21:27:16
 *Log: mrt003.c
 *----------------------------------------------------------------------*/
	...
	)
{
	...
	unsigned short	fic[DAD_FIL_MAX]	/* 係数の2次元ﾏﾄﾘｯｸｽ	*/
			   [DAD_TAP_MAX];
	union usc	k;
	long		m;
	int		len, i, n, j;
