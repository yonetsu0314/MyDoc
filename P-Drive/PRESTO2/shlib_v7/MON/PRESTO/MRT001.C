 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/shlib_v7/mon/presto/RCS/mrt001.c 1.1 1970/01/01 00:00:00 chimura Exp $
 *$Log: mrt001.c $
 * リビジョン 1.1  1970/01/01  00:00:00  chimura
 * 初期リビジョン
 * 
 *----------------------------------------------------------------------*
 *Header: p:/presto/shlib_v7/mon/src/rcs/mrt001.c 1.1 1970/01/01
 *Log: mrt001.c
 *----------------------------------------------------------------------*/
...
/*----------------------------------------------*/
	...
	if(xs &(DAD_ORG|DAD_1ST|DAD_2ND|DAD_3RD|DAD_4TH|DAD_5TH)) {
		if(dad_sta_mon( pwbid, (short)(xs &(DAD_ORG|DAD_1ST|DAD_2ND|DAD_3RD|
				DAD_4TH|DAD_5TH)), ptn, xcnt) == -1)  goto ret_fail;
	}
	if(xs >> 6) {
		if(dad_sta_dsp_mon( pwbid, (short)(xs>>6), ptn, xcnt) == -1) {
