# Renesas C
# NORTi Version4
# Network sample program makefile for Hitachi ULSI MS7615SE.
#
# net7615h.abs ... Absolute format for debugger
# net7615h.mot ... S-format for ROM
#
...
AFLAGS  = -cp=sh2 -deb
CFLAGS  = -cp=sh2 -op=1 -deb -i=$(INC1),$(INC2),$(INC3)
LDFLAGS = -su=net7615h.sub
...
OBJS = net7615.obj nonecfg.obj vec7615h.obj init7615.obj n4i7615.obj \
       ...
       nonftpc.obj nondhcp.obj nonedns.obj nos16550.obj
...
dp83843.obj : $(SRC1)\dp83843.c $(SRC1)\dp83843.h $(MAKEFILE)
    $(CC) $(CFLAGS) -c=a -def=PHYAD=0x01 $(SRC1)\dp83843.c
    $(AS) dp83843.src $(AFLAGS)
    del dp83843.src
#   $(CC) $(CFLAGS) -c=a -def=PHYAD=0x01,LOOP_BACK $(SRC1)\dp83843.c
