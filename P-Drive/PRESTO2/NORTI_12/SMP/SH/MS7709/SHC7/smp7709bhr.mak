...
#               Big Endian format
#
# smp7709bhr.abs  ... Absolute format for debugger
# smp7709bhr.mot  ... S-format for ROM
#
...
CFLAGS   = -nologo -cp=sh3 -deb -i=$(INC1),$(INC2)
LDFLAGS  = -su=smp7709bhr.sub
