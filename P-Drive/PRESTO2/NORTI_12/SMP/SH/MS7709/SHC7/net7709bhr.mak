# Hitachi C
# NORTi Version4
# Network sample program makefile for Hitachi ULSI MS7709SE.
# Big Endian format
#
# make -f net7709bhr.mak
#
# net7709bhr.abs  ... Absolute format for debugger
# net7709bhr.mot  ... S-format for ROM
#
...
AFLAGS   = -nologo -cp=sh3 -deb
CFLAGS   = -nologo -cp=sh3 -deb -op=1 -i=$(INC1),$(INC2),$(INC3)
LDFLAGS  = -su=net7709bhr.sub
...
CNV      = cnvs
MAKE     = make
MAKEFILE = net7709bhr.mak

### Files ###

OBJS  = vec7709h.obj net7709.obj initsh.obj n4i7709.obj \
		nosio.obj nos7709.obj nos16550.obj \
		nonethw.obj dp8390.obj nonelan.obj nondump.obj  \
...
nos16550.obj : $(SRC1)\nos16550.c
	$(CC) $(CFLAGS) -def=$(CPU),V4,CH0,CH=1,$(BOARD) $(SRC1)\nos16550.c
