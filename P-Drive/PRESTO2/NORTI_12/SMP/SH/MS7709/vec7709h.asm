;******************************************************************************
;* 日立Ｃベクタ設定の例（MS7709SE01)                                          *
;*                                                                            *
;*  File name : vec7709h.asm                                                  *
;*                                                                            *
;* 24/Apr/2000                                                                *
;* 22/Sep/2000  キャッシュの初期化処理を追加                                  *
;* 12/Sep/2001  VECTセクションをCODE属性に修正                             TA *
;* 24/Dec/2002 ローダによる ROM->RAMコピーに対応                           KA *
;******************************************************************************
...
_BOOT:
        ...
        mov.w   BCR1,r0         ; Hitachi ULSI Systens MS7709RP01 用設定
        mov.w   BCR1_D,r1
        mov.w   r1,@r0
        mov.w   BCR2,r0
        mov.w   BCR2_D,r1
