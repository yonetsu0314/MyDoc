/******************************************************************************
* Interval Timer Interrupt Handler (SH7709)                                   *
*                                                                             *
*  Copyright (c)  1995-2001, MiSPO Co., Ltd.                                  *
*  All rights reserved.                                                       *
*                                                                             *
* 24/Apr/2000                                                                 *
* 22/Sep/2000 フックルーチン用のダミー積算チッククロックを修正                *
...
#elif defined(__HITACHI__)      /* Hitachi C */
#include <machine.h>
extern int *_C_BGN, *_C_END, *_P_BGN, *_P_END;
#endif
...
#define MHz         1000000L
#ifndef CLK
#define CLK         20*MHz      /* peripheral clock [Hz] */
#endif

/* interrupt vector address */

#ifndef INTVEC
#define INTVEC      0xa0000000L
#endif
...
ER intini(void)
{
    ...
    {   intdef[i][0] = 0x500000f0;              /* SR MD=1,IMASK=15 */
...
ER v4_def_inh(INHNO inhno, const V4_T_DINH *pk_dinh)
{
    ...
    intdef[i][0] = 0x50000000 | (m << 4);   /* SR MD=1,IMASK=imask */
    intdef[i][1] = (UW)fp;
...
/*****************************************************************************
* Start Interval Timer (SH7709 TMU)
*
******************************************************************************/
