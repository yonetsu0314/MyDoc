...
#               Big Endian format
#
# smp7729Rbhr.abs  ... Absolute format for debugger
# smp7729Rbhr.mot  ... S-format for ROM
#
...
AFLAGS   = -cp=sh3 -deb
CFLAGS   = -nologo -cp=sh3 -deb -i=$(INC1)
LDFLAGS  = -su=smp7729Rbhr.sub
