...
*  All rights reserved.                                                     *
*                                                                           *
*  Compile : shc -cp=sh3 -op=1 -def=CLK=? nos7729.c         (Renesas C)     *
*            gcc -c -m3 -O2 -DCLK=? nos7729.c               (exeGCC)        *
*            ccsh -c -cpu=sh_iii -ansi -O -DCLK=? nos7729.c (GHS)           *
*                                                                           *
* 07/Sep/1998 作成                                                          *
* 18/Apr/2000 SH7729 用として                                               *
* 29/Oct/1998 IAR EW 対応                                                   *
...
チャネル番号の指定
          ...
          (例) shc <options> nos7729.c  ･･･････････････････････ チャネル0
               copy nos7729.c nos7ch1.c
               shc <options> -def=CH=1 nos7ch1.c  ･････････････ チャネル1

          (例) gcc <options> nos7729.c  ･･･････････････････････ チャネル0
               gcc <options> -DCH=1 -onos7ch1.o nos7729.c ･････ チャネル1

          (例) ccsh <options> nos7729.c  ･･････････････････････ チャネル0
               ccsh <options> -DCH=1 -o nos7ch1.o nos7729.c ･･･ チャネル1
...
ボーレートジェネレータ
          ...
          (例) shc <options> -def=CLK=25000000 nos7729.c ･･････ 25 MHz
                                  ~~~~~~~~~~~~
          (例) gcc <options> -DCLK=25000000 nos7729.c
                               ~~~~~~~~~~~~
送受信バッファサイズの指定
...
割込み優先順位
          ...
          (例) shc <options> -def=IP=5 nos7729.c ･･･ 割込み優先順位 5
                                  ~~~~
          (例) gcc <options> -DIP=5 nos7729.c
                               ~~~~
未サポート機能
