...
#               Big Endian format
#
# smp7729bhr.abs  ... Absolute format for debugger
# smp7729bhr.mot  ... S-format for ROM
#
...
AFLAGS   = -cp=sh3 -deb
CFLAGS   = -cp=sh3 -deb -i=$(INC1),$(INC2) -nologo
LDFLAGS  = -su=smp7729bhr.sub
