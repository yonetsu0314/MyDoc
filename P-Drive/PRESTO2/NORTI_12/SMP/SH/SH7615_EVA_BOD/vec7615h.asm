;********************************************************************************
;* SHC用ベクタテーブル設定の例（SH7615 EVA BOD+）                               *
;*                                                                              *
;*  File name : vec7615h.asm                                                    *
;*  Copyright (c) 2000-2001 MiSPO Co., Ltd.  All rights reserved.               *
;*                                                                              *
;* 11/Apr/2000 作成                                                   OK(MiSPO) *
;* 08/Feb/2001 SH7615 EVA BOD に MS7615SE 用を書き換え                OK(MiSPO) *
;* 25/Apr/2001 外部CLK=60MHz のタイミングに変更                       OK        *
;* 19/Oct/2001 ローダによる ROM->RAMコピーに対応                      TA        *
;* 09/Oct/2002 FMR初期化を最初に変更                                  KA        *
;********************************************************************************

;* ★の箇所をカスタマイズしてください
;*   SP 初期値は、RAM の最後のアドレス+1 に設定するのが一般的です。
;*   SH7615 EVA BOD+ board のSDRAMは、6000000～6FFFFFFの16MBです。
...
SD_BANK2:       .data.l  h'06400000  ;SDRAM BANK2 アドレス
SD_BANK3:       .data.l  h'06800000  ;SDRAM BANK3 アドレス
SD_BANK4:       .data.l  h'06c00000  ;SDRAM BANK4 アドレス

BCR1_DATA:      .data.l  h'a55a0001  ;CS0 NOMAL ROM/CS2=Big/CS3=SDRAM/CS4=Big
BCR2_DATA:      .data.l  h'a55a00f8  ;CS1=16bit/CS2=32bt/CS3=32bit/CS4=32bit

    .aif CACHE_WT eq 0
BCR3_DATA:      .data.l  h'a55a0001  ;Burst write
    .aelse
BCR3_DATA:      .data.l  h'a55a0000  ;Single write
    .aendi

WCR1_DATA:      .data.l  h'a55a005f  ;CS0=0 idel, wait depend on BCR1,BCR3
                                     ;CS1=0 idel, wait depend on BCR1,BCR3
                                     ;CS3=SDRAMのレイテンシ=2

WCR2_DATA:      .data.l  h'a55a000b  ;初期値
WCR3_DATA:      .data.l  h'a55a0000  ;

MCR_DATA1:      .data.l  h'a55a5dc8  ;SDRAM=32bit､AMX=4(4Mx16bit)､Auto Refresh
