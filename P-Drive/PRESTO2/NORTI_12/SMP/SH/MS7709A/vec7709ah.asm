;****************************************************************************
;* SHCベクタ設定の例（MS7709ASE01)                                          *
;*                                                                          *
;*  File name : vec7709ah.asm                                               *
;*                                                                          *
;* 24/Apr/2000                                                              *
;* 22/Sep/2000  キャッシュの初期化処理を追加                                *
;* 12/Sep/2001  VECTセクションをCODE属性に修正                           TA *
;* 09/Jul/2002 バスコントローラの再初期化を自動回避                      KA *
;* 22/Oct/2002 ローダによる ROM->RAMコピーに対応                         KA *
;* 21/Feb/2003 ラベルの共通化                                            KA *
;****************************************************************************
...
_BOOT:
        ...
        mov.w   BCR1,r0         ; Hitachi ULSI Systens MS7709ASE01 用設定
        mov.w   BCR1_D,r1
        mov.w   r1,@r0
        mov.w   BCR2,r0
        mov.w   BCR2_D,r1
...
BCR3_D:     .data.w H'0000
FRQCR_D:    .data.w H'0122
WCR1_D:     .data.w H'0C30
WCR2_D:     .data.w H'7DDB
MCR_D:      .data.w H'00AC
DCR_D:      .data.w H'0000
PCR_D:      .data.w H'0000
RTCNT_D:    .data.w H'A500
RTCOR_D:    .data.w H'A582
