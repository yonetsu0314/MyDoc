...
* 08/Feb/2001  Supported SH7615 EVA BOD+                                    *
* 24/Dec/2002 char/unsigned char のキャストを追加(ワーニングの削除)      KA *
* 14/Feb/2003 dhcp_command()の前にdly_tsk()を追加                        KA *
* 22/Apr/2003 dhcp_command()の修正(bug:16 Apr 2003)                      KA *
* 09/May/2003 MiNET-7042に特化                                           KA *
* 09/May/2003 dhcp_command実行後にコンソールの入力が無効になる問題を修正 KA *
* 09/May/2003 ftp_passwd_checkを追加                                     KA *
...
BOOL telnetd_callback(T_TERMINAL *t, B *s)
{
    ...
    if (stricmp(argv[0], (char *)"?") == 0 || stricmp(argv[0], (char *)"help") == 0)
        print((B *)"test  ip  ping  ftp  telnet  dns  dhcp");
