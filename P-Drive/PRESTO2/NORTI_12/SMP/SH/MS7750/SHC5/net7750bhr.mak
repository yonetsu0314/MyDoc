...
# Big Endian format.
# make -f net7750bhr.mak
#
# net7750bhr.abs  ... Absolute format for debugger
# net7750bhr.mot  ... S-format for ROM
#
...
AFLAGS   = -cp=sh4 -deb
CFLAGS   = -cp=sh4 -deb -op=1 -i=$(INC1),$(INC2),$(INC3) -fp=s
LDFLAGS  = /su=net7750bhr.sub
...
CNV      = cnvs
MAKE     = make
MAKEFILE = net7750bhr.mak

### Files ###

OBJS =  dp8390.obj initsh.obj n4i7750.obj net7750.obj nonecfg.obj nonethw.obj  \
        nos16550.obj nos7750.obj vec7750h.obj  \
