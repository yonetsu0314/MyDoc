...
;* 06/Jun/2001  キャッシュのパージを強制的にP2領域で実行するように修正   TA *
;* 12/Sep/2001  VECTセクションをCODE属性に修正                           TA *
;* 23/Jan/2002 ローダによる ROM->RAMコピーに対応                         KA *
;****************************************************************************
...
_BOOT:
        ...
        mov.l   BCR1,r0         ; Hitachi ULSI Systens MS7750SE01 用設定
        mov.l   BCR1_D,r1
        mov.l   r1,@r0          ; BCR1
...
SDMR3:      .data.l H'FF940110
CCR:        .data.l H'FF00001C

BCR1_D:     .data.l H'00000008
WCR1_D:     .data.l H'02720777
WCR2_D:     .data.l H'FFFE4FFF
WCR3_D:     .data.l H'01717771
MCR_D:      .data.l H'8801001C
            .data.l H'C801001C
