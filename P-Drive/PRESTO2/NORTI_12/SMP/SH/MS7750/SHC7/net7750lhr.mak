...
#
# net7750lhr.abs  ... Absolute format for debugger
# net7750lhr.mot  ... S-format for ROM
#
...
CFLAGS   = -cp=sh4 -deb -en=l -op=1 -nologo -fp=s -i=$(INC1),$(INC2),$(INC3)
LDFLAGS  = -su=net7750lhr.sub
