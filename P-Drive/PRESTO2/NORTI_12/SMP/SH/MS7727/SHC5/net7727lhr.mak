...
#
# net7727lhr.abs  ... Absolute format for debugger
# net7727lhr.mot  ... S-format for ROM
#
...
CFLAGS   = -cp=sh3 -deb -en=l -op=1 -i=$(INC1),$(INC2),$(INC3)
LDFLAGS  = /su=net7727lhr.sub
