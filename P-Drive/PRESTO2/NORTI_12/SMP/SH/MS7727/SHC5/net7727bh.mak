# Renesas C
# NORTi Version4
# Network for sample program makefile Hitachi ULSI MS7727SE.
# Big Endian format
#
# net7727bh.abs  ... Absolute format for debugger
# net7727bh.mot  ... S-format for ROM
#
...
AFLAGS   = -cp=sh3 -deb
CFLAGS   = -cp=sh3 -deb -op=1 -i=$(INC1),$(INC2),$(INC3)
LDFLAGS  = /su=net7727bh.sub
...
CNV      = cnvs
MAKE     = make
MAKEFILE = net7727bh.mak

### Files ###

OBJS  = vec7727h.obj net7727.obj initsh.obj n4i7727.obj nosio.obj \
        nos7727.obj nonethw.obj dp8390.obj nonelan.obj nondump.obj \
        nontftp.obj nonecho.obj nonechc.obj nonteld.obj nonshel.obj \
        nonftpd.obj nonfile.obj noncons.obj nonramd.obj nonping.obj \
        nondump.obj nontelc.obj nonftpc.obj nondhcp.obj nonedns.obj \
        nos16550.obj nonecfg.obj

LIBS  = $(LIB)\n4dsh3b.lib $(LIB)\n4esh3b.lib

TARGET = net7727bh.abs
