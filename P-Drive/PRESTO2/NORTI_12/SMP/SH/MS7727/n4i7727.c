/****************************************************************************
* Interval Timer Interrupt Handler (SH7727)                                 *
*                                                                           *
*  Copyright (c)  2001-2003, MiSPO Co., Ltd.                                *
*  All rights reserved.                                                     *
*                                                                           *
* 20/Jun/2001                                                               *
* 19/Sep/2001 制御系の判断を見直し                                          *
*             タイムスタンプ用のクロックの取り出しを追加                 TA *
* 27/Dec/2002 select 1/16 prescaler                                      KA *
* 27/Dec/2002 v4_def_inhで pk_dinh->imaskチェック修正間違いを修正        KA *
* 23/Feb/2003 ht1_inline.h and machine.h inclusions are moved to sh7727.hMI *
...
UW intdef[INT_SIFCCI-INT_NMI+1][2];
...
/*****************************************************************************
* Start Interval Timer (SH7709A TMU)
*
******************************************************************************/
...
ER intsta(void)
{
    ...
    sfr_outw(TMU_TCR, 0x21);        /* enable underflow interrupt and */
