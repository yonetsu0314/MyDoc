...
#define TCP_REPID_MAX   5       /* TCP受付口最大個数 */
...
#define TSKID_MAX  11+TCP_TSKID_CNT /* タスクID上限 */
#define SEMID_MAX   2+TCP_SEMID_CNT /* セマフォID上限 */
#define FLGID_MAX   1               /* イベントフラグID上限 */
#define MBXID_MAX   2+TCP_MBXID_CNT /* メイルボックスID上限 */
#define MBFID_MAX   4               /* メッセージバッファID上限 */
#define PORID_MAX   1               /* ランデブ用ポートID上限 */
#define MPLID_MAX   4               /* 可変長メモリプールID上限 */
...
#define TSTKSZ      2048            /* timer handler stack size */
#include "nocfg3.h"
