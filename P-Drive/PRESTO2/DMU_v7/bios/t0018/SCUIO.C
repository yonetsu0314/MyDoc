 ...
 *----------------------------------------------------------------------*
 *$Header: p:/presto2/dmu_v7/bios/src/rcs/scuio.c 1.2 1970/01/01 00:00:00 sakaguti Exp $
 *$Log: scuio.c $
...
static const bsci[] = {										/* baud rate 設定用テーブル */
			{(unsigned char)1,	(unsigned char)191},		/* 0 :	  1200 BPS			*/
			{(unsigned char)1,	(unsigned char)95},		/* 1 :	  2400 BPS			*/
