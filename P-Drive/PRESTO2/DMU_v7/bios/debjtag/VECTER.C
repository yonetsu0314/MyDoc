 ...
 *		アプリケーションセットアップ
 *----------------------------------------------------------------------
 *$Header: p:/presto2/dmu_v7/bios/src/rcs/vecter.c 1.7 1970/01/01 00:00:00 chimura Exp $
 *$Log: vecter.c $
 * リビジョン 1.7  1970/01/01  00:00:00  chimura
 * 2005/01/24 scuio,e2sromioを追加する。
 * 
...
const void (*const vector_table[])(void) = {
	...
	scu_io,				/* ,32 : trapa 0x20  int 80h(scu_io) */
	...
	from_io,			/* 43 : trapa 0x2b  int 8bh(from_io) */
	...
	e2srom_io,			/* ,53 : trapa 0x35  int 95h(e2srom) */
	fpga_io,			/* 54 : trapa 0x36  int 96h(fpgafifo) */
	cf_io,				/* 55 : trapa 0x37  int 97h(cf) */
