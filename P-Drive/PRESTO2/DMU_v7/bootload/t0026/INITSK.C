 ...
 *		イニシャルタスク
 *----------------------------------------------------------------------
 *$Header: p:/presto2/dmu_v7/bootload/rcs/initsk.c 4.1 1970/01/01 00:00:00 kagatume Exp $
 *$Log: initsk.c $
...
/*	タスクの定義															*/
/*--------------------------------------------------------------------------*/
const T_CTSK ctsk_main = { TA_HLNG, NULL, init_tsk, 8, 16384, NULL, (B *)"maintask" };
