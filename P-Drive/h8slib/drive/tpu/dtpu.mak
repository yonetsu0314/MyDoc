#-----------------------------------------------------------------------#
# File name	: dtpu.mak		/ tpu driver liblary						#
#-----------------------------------------------------------------------#
#*$Header: p:/h8slib/drive/tpu/RCS/dtpu.mak 1.1 1970/01/01 00:00:00 yonetsu Exp $
#*$Log: dtpu.mak $
...
#-----------------------------------------------------------------------#
# Function																#
#		TPU 関連ドライバーのライブラリーを作成する。					#
#-----------------------------------------------------------------------#

PROG	=dtpu				# Liblary name
