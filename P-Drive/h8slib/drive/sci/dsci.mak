#-----------------------------------------------------------------------#
# File name	: dsci.mak		/ sci driver liblary						#
#-----------------------------------------------------------------------#
#*$Header: p:/h8slib/drive/sci/RCS/dsci.mak 1.2 1970/01/01 00:00:00 yonetsu Exp $
#*$Log: dsci.mak $
...
#-----------------------------------------------------------------------#
# Function																#
#		SCI関連ドライバーのライブラリーを作成する。						#
#-----------------------------------------------------------------------#

PROG	=dsci				# Liblary name
