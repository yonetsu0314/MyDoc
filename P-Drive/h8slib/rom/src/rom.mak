#-----------------------------------------------------------------------#
# File name	: rom.mk		/ Romable liblary							#
#-----------------------------------------------------------------------#
#$Header: p:/h8slib/rom/src/RCS/rom.mak 1.1 1970/01/01 00:00:00 yonetsu Exp $
#$Log: rom.mak $
...
$(PROG).sub	: $(PROG).mak
##  メイクコマンドとして Microsoft の nmake.exe を使用する場合
#   $(LRF) @<<$(PROG).SUB
#create	$(TARGET)
#add		$(OBJS: =^
#add		)
...
#exit
#<<KEEP
##  メイクコマンドとして Borland の make.exe を使用する場合
