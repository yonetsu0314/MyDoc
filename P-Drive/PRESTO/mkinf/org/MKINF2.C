/*
 *$Header: p:/presto/mkinf/rcs/mkinf2.c 1.7 1970/01/01 00:00:00 sakaguti Exp $
 *$Log: mkinf2.c $
...
main(int argc,char **argv){
	...
	printf("MKINF2 INF file Generator Version 1.7\n");
	...
	if(funcnum <= 0){
		rsstr("ERROR:Append option.( -mcu or -dmu or -mhic)\n");
		return(-1);
	}
