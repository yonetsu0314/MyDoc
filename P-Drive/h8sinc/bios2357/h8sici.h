/*----------------------------------------------------------------------*
 * File name	: h8sici.h		/ H8S ICI context header				*
 *----------------------------------------------------------------------*
 *$Header: p:/h8sinc/bios2357/RCS/h8sici.h 1.1 1970/01/01 00:00:00 yonetsu Exp $
 *$Log: h8sici.h $
...
#define ICI0	(*(volatile struct st_ici	*)0xFFFF78) /* ICI0  Address*/
#define ICI1	(*(volatile struct st_ici	*)0xFFFF80) /* ICI1  Address*/
#define ICI2	(*(volatile struct st_ici	*)0xFFFF88) /* ICI2  Address*/
